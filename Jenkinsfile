pipeline {
  ...
  stages {
    ...
    stage('Build and Push Docker Image') {
      environment {
        DOCKER_IMAGE = "arjunsurya27/ultimate-cicd:${BUILD_NUMBER}"
      }
      ...
      steps {
        withCredentials([
          ...
          sh '''
            ...
            sed -i "s|image: .*|image: arjunsurya27/ultimate-cicd:${BUILD_NUMBER}|g" node-app-manifests/deployment.yml
